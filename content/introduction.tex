...
% While this proposed solution is modelled with PoW in mind, it has the potential to be applied to other consensus algorithms such as Proof of Stake by offering up the stake as the \textit{chunk} on the marketplace \todo{unsure about this}.
