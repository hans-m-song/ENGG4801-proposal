...
\paragraph{} The purpose of this project is to model and verify a system inspired by Harberger's Tax, \todo{cite?} an economic policy that aims to prevent unequal distribution of ownership through two rules:
...
that has a focus on negating the vulnerability introduced by the centralization of computation through a self-assessed valuation \todo{need a better phrase for this}
